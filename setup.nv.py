...
def ensure_pip(python_exec):
    ...
    try:
        ...
        log("pip не знайдено. Встановлюємо pip...")
...
def parse_files_to_scan(files_str):
    ...
    Параметри:
        files_str (str): Рядок, що містить файли та папки, розділені комами або пробілами.
        
    Повертає:
        list: Список шляхів до файлів та папок.
    """
...
def get_outdated_packages(python_exec, dependencies):
    ...
    Повертає:
        list: Список застарілих пакетів.
    """
